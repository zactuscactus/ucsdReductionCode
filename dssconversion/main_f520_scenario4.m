...
%% Scenario 4: 10 times more PV than scenario 1 (excluding 2 big pv sites)
...
%% remove 2 big pv sites
[x pid] = max([c.pvsystem.kVA]);
c.pvsystem(pid) = [];
[x pid] = max([c.pvsystem.kVA]);
c.pvsystem(pid) = [];
...
save([temp '/scenario4_case0.mat'],'c','glc');
...
save([temp '/scenario4_case1.mat'],'c','glc');
...
save([temp '/scenario4_case2.mat'],'c','glc');
...
save([temp '/scenario4_case3.mat'],'c','glc');
...
save([temp '/scenario4_case4.mat'],'c','glc');
...
save([temp '/scenario4_case5.mat'],'c','glc');
...
save([temp '/scenario4_case6.mat'],'c','glc');