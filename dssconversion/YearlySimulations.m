function [] = YearlySimulations(Commands, SimName, stepsize, SimPer, p, PVSys, NumPts)
...
disp('-- Running Yearly Simulations --');
...
dssText.Command = ['Set mode = yearly stepsize = ' stepsize];% time will advance based on stepsize (e.g. 1h or 15m) for each solve
...
dssText.Command = 'Set controlmode = static';
dssText.Command = ['Set mode = yearly stepsize = ' stepsize];
dssText.Command = 'Set number = 1';% will stop after each solve
...
StartDate = datenum('06/28/2012 00:00:00','mm/dd/yyyy HH:MM:SS');
EndDate = datenum('07/02/2013 23:59:45','mm/dd/yyyy HH:MM:SS');
...
for j=1:15
    ...
    switch j
        ...
        case 5
            ...
            z_saturation=[0 10000];
            z_range=(-3000:1000:3000);
        case 6
            Values_DistanceAxis = distB;
        ...
        case 9
            ...
            z_saturation=[-3000 3000];
            z_range=(-1000:250:500);
        case 10
            Values_DistanceAxis = distB;
