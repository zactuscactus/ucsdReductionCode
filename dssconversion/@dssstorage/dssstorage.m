function obj = dssstorage(s,varargin)
% OpenDSS Storage object
%
...
if(nargin==1 && isa(s,cn))
	...
	obj.namemap = struct('Charge','%Charge','Discharge','%Discharge',...
		'EffCharge','%EffCharge','EffDischarge','%EffDischarge','Idlingkvar',...
		'%Idlingkvar','IdlingkW','%IdlingkW','reserve','%reserve',...
		'stored','%stored','R','%R','X','%X');
end
