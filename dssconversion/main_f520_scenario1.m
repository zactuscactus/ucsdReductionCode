...
save([temp '/scenario1_case0.mat'],'c','glc');
...
save([temp '/scenario1_case1.mat'],'c','glc');

%% END: Simulation 
temp = 'tmp_scnr1';
Commands={};
SimName = ['Scenario 1 case 1'];
stepsize = '30s';
PVsyst = {'pv'};
SimPer = 24;
NumPts = 2880;
...
save([temp '/scenario1_case2.mat'],'c','glc');
...
save([temp '/scenario1_case3.mat'],'c','glc');
...
save([temp '/scenario1_case4.mat'],'c','glc');
...
save([temp '/scenario1_case5.mat'],'c','glc');
...
save([temp '/scenario1_case6.mat'],'c','glc');