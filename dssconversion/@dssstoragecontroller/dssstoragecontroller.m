function obj = dssstoragecontroller(s,varargin)
% OpenDSS storage controller object
...
if(nargin==1 && isa(s,cn))
	...
	obj.namemap = struct('kWBand','%kWBand','Participation','%Participation',...
		'RateCharge','%RateCharge','Ratekvar','%Ratekvar','RatekW',...
		'%RatekW','Reserve','%Reserve');
end
