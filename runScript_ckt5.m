...
pathToFile='C:\Users\Zactus\FeederReduction\ckt5\Master_ckt5.dss';
aname='ckt5';
...
save('OutputDSS/ckt5_max_mean.mat','Vmax','Vmean','CB','time_full','time_red','red_time')