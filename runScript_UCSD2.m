...
[circuit, circuit_orig, ~, ~, ~,voltDiff] = reducingFeeders_UCSD(pathToFile,criticalBuses,[],1)
...
save('OutputDSS/UCSD2_max_mean.mat','Vmax','Vmean','CB','time_full','time_red','red_time')