...
% pathToFile='C:\Users\Zactus\FeederReduction\ckt24\Master_ckt24.dss';
...
for ii=inds
	...
	[circuit, circuit_orig, ~, ~, ~,voltDiff] = reducingFeeders_play_2_12_13_2017(pathToFile,criticalBuses,[],1)
% 	save(['P:\users\Zack\FR2_sims\SimNewFR_ieee8500_buses' num2str(ii) '.mat'],'voltDiff')
