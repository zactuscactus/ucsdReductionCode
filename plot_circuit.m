...
% 	end
	if any(ismemberi('n312299',busName(flag(i,1))))
	  text(x_tmp(1,1),y_tmp(1,1),busName(flag(i,1)))
	elseif any(ismemberi('n312299',busName(flag(2,1))))
	  text(x_tmp(1,2),y_tmp(1,2),busName(flag(i,2)))
	end
	
	if any(ismemberi('n312304',busName(flag(i,1))))
	  text(x_tmp(1,1),y_tmp(1,1),busName(flag(i,1)))
	elseif any(ismemberi('n312304',busName(flag(2,1))))
	  text(x_tmp(1,2),y_tmp(1,2),busName(flag(i,2)))
	end
			end
	end
...
if isfield(c,'transformer')
	...
	for ii=1:length(trf)
		...
		h(2)=plot(bus_coord(bus(ii),1),bus_coord(bus(ii),2),'bo','MarkerFaceColor','b','markersize',8,'markeredgecolor','b');
	end
end
...
% h(2)=plot(bus_coord(T,1),bus_coord(T,2),'go','MarkerFaceColor','g','markersize',8,'markeredgecolor','g');
