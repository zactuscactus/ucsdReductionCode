...
% load('c:\users\zactus\FeederReduction\StateEstimation\Reduced13circ.mat');c=circuit;
% c = dssparse('C:\Users\Vahid\Google Drive\UCSD\Zack\State Estimation\Zack\WLS Code\IEEETestCases\4Bus-DY-Bal\4Bus-DY-Bal.DSS');
% c = dssparse('C:\Users\Zactus\Google Drive\Zack\State Estimation\Zack\WLS Code\IEEETestCases\34Bus\Ieee34Mod1.dss');
...
%     close all
    pre_nl=noise_level;
    [Z,Yk,Ykbar,D,Ykl,Yklbar,Ycomb,volt,volt1,M,W,ybus,basekv,Ybase,true_volt]=GenMeasCode(c,noise_level);
