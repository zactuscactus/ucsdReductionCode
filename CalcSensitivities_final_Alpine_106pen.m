...
load('FilesForCalcSensitivity.mat')
...
% 	end
[a,b1]=fit(c.loadshape(2).mult(1:50),res.Voltage(1:end,1008)-res.Voltage(end,1008),'poly1')
[a,b2]=fit(c.loadshape(2).mult(1:50),res.Voltage(1:end,1008)-res.Voltage(end,1008),'poly2')
[a,b3]=fit(c.loadshape(2).mult(1:50),res.Voltage(1:end,1008)-res.Voltage(end,1008),'poly3')
hold on;plot(c.loadshape(2).mult(1:50),res.Voltage(1:end,1008)-res.Voltage(end,1008))
% 	c.load(ii).daily='loadshape_unity';
% end
end
PTDF_l_real=PTDF_l;
...
toc
save('Sensitivy_file_Alpine_106pen.mat','PTDF_l_real','PTDF_pv_real','V_o')